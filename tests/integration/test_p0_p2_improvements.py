...
class TestYaraInputValidation:
    ...
    @pytest.mark.asyncio
    async def test_yara_rule_name_validation(
        self, sample_binary_path, patched_workspace_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_yara_string_sanitization(
        self, sample_binary_path, patched_workspace_config
    ):
...
class TestR2PoolAsync:
    ...
    @pytest.mark.asyncio
    async def test_r2_pool_async_execution(
        self, sample_binary_path, patched_workspace_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_r2_pool_async_session(
        self, sample_binary_path, patched_workspace_config
    ):
...
class TestCircuitBreakerSync:
    ...
    def test_circuit_breaker_sync_decorator(self):
        ...
        from reversecore_mcp.core.resilience import circuit_breaker_sync, get_circuit_breaker
    ...
    async def test_circuit_breaker_auto_detection(self):
        ...
        from reversecore_mcp.core.resilience import circuit_breaker, _breakers
...
class TestBinwalkExtraction:
    ...
    @pytest.mark.asyncio
    async def test_binwalk_extract_basic(
        self, sample_binary_path, patched_workspace_config
    ):
    ...
    async def test_binwalk_extract_with_custom_output_dir(
        ...
        result = await run_binwalk_extract(
            str(sample_binary_path),
...
class TestGhostTraceCaching:
    ...
    @pytest.mark.asyncio
    async def test_ghost_trace_cached_execution(
        self, sample_binary_path, patched_workspace_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_ghost_trace_bypass_cache(
        self, sample_binary_path, patched_workspace_config
    ):
